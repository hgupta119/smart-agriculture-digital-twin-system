<p align="center">
  <img src="assets/banner/banner.png" alt="Smart Agriculture Digital Twin Banner" width="100%" />
</p>

<p align="center">
  <img src="assets/banner/logo.png" alt="Smart Agriculture Digital Twin Logo" width="120" />
</p>
...
<p align="center">
  <a href="https://github.com/mishraanshul870-lab/smart-agriculture-digital-twin-system"><img src="https://img.shields.io/github/stars/mishraanshul870-lab/smart-agriculture-digital-twin-system?style=for-the-badge&color=gold" alt="GitHub Stars" /></a>
  <a href="https://github.com/mishraanshul870-lab/smart-agriculture-digital-twin-system"><img src="https://img.shields.io/github/forks/mishraanshul870-lab/smart-agriculture-digital-twin-system?style=for-the-badge&color=blue" alt="GitHub Forks" /></a>
  <a href="https://github.com/mishraanshul870-lab/smart-agriculture-digital-twin-system/issues"><img src="https://img.shields.io/github/issues/mishraanshul870-lab/smart-agriculture-digital-twin-system?style=for-the-badge&color=red" alt="GitHub Issues" /></a>
  <a href="https://github.com/mishraanshul870-lab/smart-agriculture-digital-twin-system/commits/main"><img src="https://img.shields.io/github/last-commit/mishraanshul870-lab/smart-agriculture-digital-twin-system?style=for-the-badge" alt="GitHub Last Commit" /></a>
  <img src="https://img.shields.io/github/languages/top/mishraanshul870-lab/smart-agriculture-digital-twin-system?style=for-the-badge&color=green" alt="GitHub Top Language" />
  <img src="https://img.shields.io/github/repo-size/mishraanshul870-lab/smart-agriculture-digital-twin-system?style=for-the-badge&color=orange" alt="GitHub Repo Size" />
</p>

<p align="center">
  <img src="https://img.shields.io/badge/React-19-61DAFB?style=for-the-badge&logo=react" alt="React" />
  <img src="https://img.shields.io/badge/TypeScript-5-3178C6?style=for-the-badge&logo=typescript" alt="TypeScript" />
  <img src="https://img.shields.io/badge/Node.js-22-339933?style=for-the-badge&logo=nodedotjs" alt="Node.js" />
  <img src="https://img.shields.io/badge/Express-4-000000?style=for-the-badge&logo=express" alt="Express" />
  <img src="https://img.shields.io/badge/MongoDB-Atlas-47A248?style=for-the-badge&logo=mongodb" alt="MongoDB" />
  <img src="https://img.shields.io/badge/Gemini_AI-API_Integrations-4285F4?style=for-the-badge&logo=google" alt="Google Gemini AI" />
  <img src="https://img.shields.io/badge/Hosted_On-Render-46E3B7?style=for-the-badge&logo=render" alt="Hosted On Render" />
...
graph TD
    %% Styling Definitions
    classDef client fill:#9333EA,stroke:#ffffff,stroke-width:2px,color:#fff;
    classDef server fill:#2563EB,stroke:#ffffff,stroke-width:2px,color:#fff;
    classDef storage fill:#10B981,stroke:#ffffff,stroke-width:2px,color:#fff;
    classDef external fill:#F59E0B,stroke:#ffffff,stroke-width:2px,color:#fff;

    %% Client Layer
    subgraph SPA_Client [React SPA Web Application]
        Dashboard[Dashboard Component]:::client
        AddRecords[Data Entry Form]:::client
        LeafScan[Pathology Scanner]:::client
        AIChat[Agronomist Chat]:::client
        Reports[PDF Reports]:::client
    end

    %% Server Layer
    subgraph REST_Backend [Express Node.js Web Server]
        Router[API Route Controllers]:::server
        AuthMiddleware[JWT Authenticator]:::server
        TelemetrySim[IoT Background Loop]:::server
        TranslationSvc[Translation Handler]:::server
    end

    %% Storage & External APIs
    subgraph Storage_AI [Data Store & Models]
        Mongo[(MongoDB Cloud Atlas)]:::storage
        Gemini[Google Gemini API]:::external
        OpenMeteo[Open-Meteo Weather API]:::external
    end

    %% Routing Flows
    Dashboard --> |Fetch Telemetry Data| Router
    AddRecords --> |Submit Form POST| Router
    LeafScan --> |Upload Image Payload| Router
    AIChat --> |Send Query POST| Router
    Reports --> |Read Historical Logs| Router

    %% Middleware & Simulator Flows
    Router --> AuthMiddleware
    TelemetrySim --> |Write Random Sensor Values| Mongo
    
    %% Backend Integrations
    Router --> |Query / Write Docs| Mongo
    Router --> |Translate Page JSON| TranslationSvc
    TranslationSvc --> Gemini
    Router --> |Pathology & Chat Prompting| Gemini
    Router --> |Weather Coordinate Sync| OpenMeteo
```
...
<div align="center">
  ...
  <img src="assets/screenshots/login.png" width="90%" alt="Login Screen" />
...
<div align="center">
  ...
  <img src="assets/screenshots/dashboard.png" width="90%" alt="Dashboard Screen" />
...
<div align="center">
  ...
  <img src="assets/screenshots/yield-prediction.png" width="90%" alt="Yield prediction Screen" />
...
<div align="center">
  ...
  <img src="assets/screenshots/notifications.png" width="90%" alt="Notifications Screen" />
...
<div align="center">
  ...
  <img src="assets/screenshots/reports.png" width="90%" alt="Reports Screen" />
...
<div align="center">
  ...
  <img src="assets/screenshots/ai-assistant.png" width="90%" alt="AI Assistant Screen" />
...
<div align="center">
  ...
  <img src="assets/screenshots/farm-layout.png" width="90%" alt="Farm Management Layout Screen" />
...
<div align="center">
  ...
  <img src="assets/screenshots/add-record.png" width="90%" alt="Add Record Screen" />
...
<div align="center">
  ...
  <img src="assets/screenshots/profile.png" width="90%" alt="Profile Screen" />
