...
const DiseaseDiagnosisSchema: Schema = new Schema({
  ...
  imageForensics: { type: String, default: '' },
  metadataAnalysis: { type: String, default: '' },
  explainableAi: { type: String, default: '' },
  manipulationDetection: { type: String, default: '' },
  riskAssessment: { type: String, default: '' },
  investigationTimeline: { type: String, default: '' },
